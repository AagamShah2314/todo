...
function addItem()
{   
    let divParentP = document.createElement("div");
    let divChildP = document.createElement("div");
    let checkIconP = document.createElement("i");
    let trashIconP = document.createElement("i");
    if (input.value === '')
    {
